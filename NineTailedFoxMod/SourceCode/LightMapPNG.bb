...
Text 5,45,"2 - Revert options.ini to use the old rmeshes"
...
If state=1 Then
	...
	f%=ReadFile("NineTailedFoxMod\Data\rooms_to_lmPNG.ini")
	...
	While Not Eof(f)
		...
		If Left(TemporaryString,1) = "[" Then
			...
			If TemporaryString <> "room ambience" Then
				Stri=GetINIString("NineTailedFoxMod\Data\rooms_to_lmPNG.ini",TemporaryString,"mesh path")
				...
				ic\file="NineTailedFoxMod\Data\rooms_to_lmPNG.ini"
...
;~F#2B#40#4E#52#A3#B1#B9#C1#C5#C9#DA#EA#EF#F4#F9#10A#120
;~C#Blitz3D